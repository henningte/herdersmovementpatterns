...
* [Submit a post for your issue](https://github.com/henningte/herdersmovementpatterns/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/henningte/herdersmovementpatterns/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:

    `git clone git@github.com:henningte/herdersmovementpatterns.git`
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/henningte/herdersmovementpatterns/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/henningte/herdersmovementpatterns/compare/).
...
* Engage in discussion on [your issue](https://github.com/henningte/herdersmovementpatterns/issues/).
